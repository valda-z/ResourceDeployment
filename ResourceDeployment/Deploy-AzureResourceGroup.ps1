...
Param(
    ...
    [string] $ResourceGroupName = 'ResourceDeployment',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'Templates\DockerOnUbuntuServer.json',
    [string] $TemplateParametersFile = 'Templates\DockerOnUbuntuServer.parameters.json',
